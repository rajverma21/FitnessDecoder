...
function WhyChooseUs () {
  return (
    <div className='flex flex-col gap-[3rem] justify-center items-center h-[100vh] w-[100%] px-[8rem] bg-[#efefef]'>
      <div>
        <h1 className='text-[4rem] text-[#424141] font-[400] underline-offset-4 underline'>Hello Bhai Log!</h1>
      </div>
